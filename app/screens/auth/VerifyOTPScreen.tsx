...
const VerifyOTPScreen: React.FC<VerifyOTPScreenProps> = ({ route, navigation }) => {
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      if (forResetPassword) {
        await api.post("/verify-otp-reset", { email, otp });
        Alert.alert("Success", "OTP verified");
        navigation.navigate("CreatePassword", { email, otp, forResetPassword: true });
      } else {
        ...
        Alert.alert("Success", "OTP verified");
        navigation.navigate("CreatePassword", { customerNumber, email, otp, forResetPassword: false });
      }
    } catch (error: any) {
          ...
          >
            <Center mt={screenHeight * 0.1}>
              <Box style={styles.iconCircle}>
                <MaterialCommunityIcons name="shield-check-outline" size={40} color="#388E3C" />
              </Box>
            ...
            <Box style={styles.formCard}>
              <Box mb="$5">
                ...
                <View style={styles.modernInput}>
                  <MaterialCommunityIcons name="numeric" size={20} color="#388E3C" />
                  <TextInput
                    ...
                    maxLength={6}
                    style={[styles.textInput, { letterSpacing: 8, fontSize: 22, fontWeight: "700", textAlign: "center" }]}
